...
function Start()
    ...
    BaseRotorJoint = API_GameObject.BL_GetComponent(TurretBaseRotor, "ConfigurableJoint")
    WeaponRotorJoint = API_GameObject.BL_GetComponent(TurretWeaponRotor, "ConfigurableJoint")
