...
function Start()
    ...
    if(SliderCrate ~= nil) then
        SliderCircuitComponent = API_GameObject.BL_GetComponent(SliderCrate,"SwitchDecorator")
        SliderPoseComponent = API_GameObject.BL_GetComponent(SliderCrate,"MarrowEntityPoseDecorator")
    ...
    ValueCircuit = API_GameObject.BL_GetComponent(BL_Host,"ValueCircuit")
