...
function Start()
    ...
    WeaponLaser = API_GameObject.BL_FindInChildren(BL_Host,"Laser").gameObject
    LaserLine = API_GameObject.BL_GetComponent2(WeaponLaser,"LineRenderer")
    HeatIndicator = API_GameObject.BL_FindInChildren(BL_Host,"HeatIndicator").gameObject
    HeatIndicatorDisplay = API_GameObject.BL_GetComponent2(HeatIndicator,"LuaBehaviour")


    FirePoint = API_GameObject.BL_FindInChildren(BL_Host,"FirePoint")
    LaserFireSound = API_GameObject.BL_GetComponent2(BL_Host,"AudioSource")
...
function Update()
    ...
    if(not API_GameObject.BL_IsValid(WeaponLaser) or not API_GameObject.BL_IsValid(HeatIndicator) or LaserLine == nil or not HeatIndicatorDisplay.Ready) then
