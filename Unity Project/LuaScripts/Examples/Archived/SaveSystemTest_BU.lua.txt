function Start()
   ...
   -- ColorDisplay1 = API_GameObject.BL_GetComponent(saveLoadResource.GetObject("ColorDisplay1","GameObject"),"LuaBehaviour")
    --ColorDisplay2 = API_GameObject.BL_GetComponent(saveLoadResource.GetObject("ColorDisplay2","GameObject"),"LuaBehaviour")
    --ColorDisplay3 = API_GameObject.BL_GetComponent(saveLoadResource.GetObject("ColorDisplay3","GameObject"),"LuaBehaviour")
    --ColorDisplay4 = API_GameObject.BL_GetComponent(saveLoadResource.GetObject("ColorDisplay4","GameObject"),"LuaBehaviour")
...
function SetupButtonReferences()
    ...
    --set the ColorDisplays to the button status - moved to built in material switchers so not used
    --ColorDisplay1.CallFunction("SetStatus",Button1Controller._charged,0,0,0)
    --ColorDisplay2.CallFunction("SetStatus",Button2Controller._charged,0,0,0)
    --ColorDisplay3.CallFunction("SetStatus",Button3Controller._charged,0,0,0)
    --ColorDisplay4.CallFunction("SetStatus",Button4Controller._charged,0,0,0)
